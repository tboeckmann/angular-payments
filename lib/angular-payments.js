  ...
  return {
    ...
    link: function(scope, elem, attr) {
      ...
      form.bind('submit', function() {
        ...
        if(form.hasClass('ng-valid') && form.attr('stripe-bypass') != "true" ) {
        ...
        } else if ( form.attr('stripe-bypass') === "true" ){
          // scope[attr.stripeForm].apply(scope, [200, {success: 'Stripe bypassed.'}]);
          button.prop('disabled', false);          
        } else {
          scope.$apply(function() {
